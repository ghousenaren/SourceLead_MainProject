...
extension NewExpensesViewController: CVCalendarViewDelegate, CVCalendarMenuViewDelegate {
    struct Color {
    ...
    func didSelectDayView(_ dayView: CVCalendarDayView, animationDidFinish: Bool) {
        selectedDay = dayView
        if selectedDateButton == "start" {
            startButton.setTitle(selectedDay.date.commonDescription, for: .normal)
        }else {
            endButton.setTitle(selectedDay.date.commonDescription, for: .normal)
        }
        calendarHolder.isHidden = true
    }
...
extension NewExpensesViewController: CVCalendarViewAppearanceDelegate {
